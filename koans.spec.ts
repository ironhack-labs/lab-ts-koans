...
describe("TypeScript Koans - Test Suite 6", () => {
  it("functions in TypeScript", () => {
    ...
    // TypeScript will throw an error when trying to add a number and a string
    // expect(add(5, '2')).toEqual(7);
    // TypeScript will ignore the extra arguments and calculate the sum of the first two arguments
...
class SportsCar extends Car {
  ...
  private getMakeFromBaseClass(): string {
    ...
    expect(this.make).toEqual("Ferrari");
    return this.getMake();
  }
}
...
describe("TypeScript Koans - Test Suite 8", () => {
  it("type annotations", () => {
    ...
    //This fail beacuse is expecting a number
