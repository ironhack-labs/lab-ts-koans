describe('TypeScript Koans - Test Suite 1', () => {
  it('type inference', () => {
    ...
    expect(typeof numberOrString === 'number' || typeof numberOrString === 'string').toEqual(true);
    ...
    expect(typeof result === 'number' || typeof result === 'string').toEqual(true);
...
class SportsCar extends Car {
  ...
  public getYearFromBaseClass(): number {
    ...
    expect(this.year).toEqual(this.year);
    // @ts-expect-error
    return this.getYear();
  }
  ...
  private getMakeFromBaseClass(): string {
    ...
    expect(this.make).toEqual(this.make);
    return this.getMake();
  }
}
