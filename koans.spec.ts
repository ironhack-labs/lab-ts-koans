describe("TypeScript Koans - Test Suite 1", () => {
  it("type inference", () => {
    ...
    expect(typeof result).toEqual("number" || "string");

    // Koan 5: TypeScript can infer the type when using isNaN function
    const nanCheck = isNaN(5 / 2);
...
describe("TypeScript Koans - Test Suite 2", () => {
  it("objects in TypeScript", () => {
    ...
    expect(user.isAdmin).toEqual(true || undefined);
    ...
    expect(typeof car.make).toEqual("string");
...
describe("TypeScript Koans - Test Suite 4", () => {
  it("tuples in TypeScript", () => {
    ...
    let person: [string, number, boolean, undefined] = [
      "John Doe",
      30,
      true,
      undefined,
    ...
    expect(person).toEqual(["John Doe", 25, true, undefined]);
...
const sportsCar = new SportsCar("Tesla", "Model S", 2023, 1000);
...
describe("TypeScript Koans - Test Suite 8", () => {
  it("type annotations", () => {
    ...
    // expect(typeof calculateSquare('5')).toEqual(25);
  });
});
