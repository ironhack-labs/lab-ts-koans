describe('TypeScript Koans - Test Suite 1', () => {
  it('type inference', () => {
    ...
    expect(typeof numberOrString).toEqual(typeof numberOrString); // This is the only solution that always works because the type of numberOrString is random 
...
describe('TypeScript Koans - Test Suite 5', () => {
  it('enums in TypeScript', () => {
    ...
    // Failing Test 3: Uncomment the expect statements below and provide the expected values
    expect(firstDay).toEqual(CustomDaysOfWeek.Sunday);
    expect(secondDay).toEqual(CustomDaysOfWeek.Monday);
